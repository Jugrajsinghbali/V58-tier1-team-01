  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        {renderSelect('Solo Tier', 'soloProjectTier', getUniqueValues('soloProjectTier'))}
        {renderSelect('Voyage Tier', 'voyageTier', getUniqueValues('voyageTier'))}
      ...
      <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
        ...
        <button
          onClick={onApply}
          className="px-8 py-2.5 rounded-xl bg-indigo-600 text-white font-medium hover:bg-indigo-700 transition-colors shadow"
        >
          Apply Filters
        </button>
      </div>
